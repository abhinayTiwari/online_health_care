   ...
   <div id="main-container">
	...
	<div id="content-container">
      <div class="sidebar ohc_shadow">
          <table>
              <tr>
               	   <td class="ohc_button sidebar-link"  goTo="searchdoctor.jsp">Search</td>
              </tr>
              <tr>
                   <td class="ohc_button sidebar-link"  goTo="<%=request.getContextPath()%>/patientProfileController">Edit Profile</td>
              </tr>   
              <tr>
                   <td class="ohc_button sidebar-link"  goTo="feedback.jsp">Feedback</td>
              </tr>           
          </table>     
      </div>
